...
@IBDesignable
public class CAYRadialGradientView: CAYShadowView {
...
@IBDesignable
public class CAYLinearGradientView: CAYShadowView {
...
@IBDesignable
public class CAYLinearThreeColorsGradientView: CAYShadowView {
...
@IBDesignable public class CAYShadowView: UIView{
...
@IBDesignable open class CAYShapeView: UIView{
